...
if __name__ == '__main__':
    ...
    parser.add_argument('--savemodel', default='E_model/E_group/cc/MultiMetaLSTM') # catnlp
    parser.add_argument('--savedset', help='Dir of saved data setting', default='E_model/E_group/cc/MultiMetaLSTM/train_bmes.dset') # catnlp
    parser.add_argument('--dataset', help='Dir of datset', default='data/E_group/cc/data_path.txt')
