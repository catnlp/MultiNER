...
if __name__ == '__main__':
    ...
    parser.add_argument('--savemodel', default='E_model/E_group/conll2003/') # catnlp
    parser.add_argument('--savedset', help='Dir of saved data setting', default='E_model/E_group/conll2003/train_bmes.dset') # catnlp
    parser.add_argument('--dataset', help='Dir of datset', default='data/E_group/conll/data_path.txt')
    ...
    if status == 'train':
        ...
        for label in config.label_alphabet.instances:
            print(label)
        name = 'E_multi_conll-kaggle-2003_bmes'
