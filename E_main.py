...
@Time: 2018/5/2 14:14
'''
from E_util.config import Config
from E_util.helpers import *
...
if __name__ == '__main__':
    ...
    parser.add_argument('--savemodel', default='E_model/conll2003/train_bmes') # catnlp
    parser.add_argument('--savedset', help='Dir of saved data setting', default='E_model/conll2003/train_bmes.dset') # catnlp
    parser.add_argument('--train', default='data/E_group/conll/train.bmes')
    parser.add_argument('--dev', default='data/E_group/conll/devel.bmes')
    parser.add_argument('--test', default='data/E_group/conll/test.bmes')
    parser.add_argument('--gpu', default='True')
    parser.add_argument('--seg', default='True')
    parser.add_argument('--extendalphabet', default='True')
    parser.add_argument('--raw', default='data/E_group/conll/test.bmes')
    parser.add_argument('--loadmodel', default='E_model/conll2003/train_bmes/conll2003_train_bmes')
    parser.add_argument('--output', default='data/E_group/conll/decode_train_bmes.txt')
